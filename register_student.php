				...
				<div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
					<div class="login-panel panel panel-success">
						<div class="panel-heading">
							<center><h3 class="panel-title">Student Registration</h3></center>
						</div>
						<div class="panel-body">
							<form role="form" method="post" action="register_student.php">
								<fieldset>
									...
									<div class="form-group">
										<input class="form-control" placeholder="Roll number" name="roll" type="text" autofocus>
									</div>

									<div class="form-group">
										<label for="year">Year</label>
										<select class="form-control" id="year" name="year" type="text" autofocus>
									...
									<div class="form-group">
										...
										<select class="form-control" id="dept" name="dept" type="text" autofocus>
